...
<div class="mx-5 mt-5" contenteditable="true">
            ...
            <div>
                ...
                <div class="mt-3">
                    <p>Na osnovu čl. 169. Zakona o upravnom postupku (&sbquo;&sbquo;Službene novine FBiH&lsquo;&lsquo;, br: 02/98 i
                        ...
                        <span class="surname text-uppercase"><?php echo $surname?></span> (<span class="parentsName text-uppercase"><?php echo $parentsName?></span>) <span class="name text-uppercase"><?php echo $name?></span>, izdaje se:
                    </p>
                </div>
            </div>
    ...
    <div class="mt-5">
        <p>
            Da je <span class="ucenikSurname surname text-uppercase"> <?php echo $surname?> </span> <span class="ucenikName name text-uppercase"><?php echo $name?></span> Sin/Kći <span class="parentsName text-uppercase"><?php echo $parentsName?></span>-a rođen-a <span class="dateOfBirth" id="dateOfBirth"><?php echo $dateOfBirth?></span>. u Bihaću, općina <span class="city">Bihać</span>, redovan-na je učenik-ca
            <span class="razTxt italic"><?php echo $razred[1]?></span> (<span class="razred"><?php echo $razred[0]?></span>) razreda i redovno pohađa nastavu u školskoj <?php echo $skolskaGodina;?> godini. Uvjerenje se izdaje na osnovu
